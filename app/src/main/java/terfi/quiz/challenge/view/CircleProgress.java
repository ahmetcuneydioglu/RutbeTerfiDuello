...
public class CircleProgress extends View
{
    ...
    private int mMaxProgress = Integer.parseInt(DataManager.timer);
    ...
    private void defaultParam()
    {
        ...
        this.mMaxProgress = Integer.parseInt(DataManager.timer);
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        switch (type){
            case ARC:
                ...
                break;
            case SECTOR:
                this.mCircleAttribute.mTextPaint.setColor(Color.BLACK);
                canvas.drawArc(this.mCircleAttribute.mRoundOval, 0.0F, 360.0F, this.mCircleAttribute.mBRoundPaintsFill, this.mCircleAttribute.mBottomPaint);
                canvas.drawArc(this.mCircleAttribute.mRoundOval, this.mCircleAttribute.mDrawPos, f1, this.mCircleAttribute.mBRoundPaintsFill, this.mCircleAttribute.mSubPaint);
                canvas.drawText(this.mSubCurProgress + "", this.mCircleAttribute.mRoundOval.centerX(), this.mCircleAttribute.mRoundOval.centerY()+textHeight/2,this.mCircleAttribute.mTextPaint);
                break;
            case ROUND:
                float top=this.mCircleAttribute.mRoundOval.height()-this.mCircleAttribute.mRoundOval.height()*this.mSubCurProgress/Integer.parseInt(DataManager.timer);
                this.mCircleAttribute.mTextPaint.setColor(Color.BLACK);
                canvas.drawArc(this.mCircleAttribute.mRoundOval, 0.0F, 360.0F, this.mCircleAttribute.mBRoundPaintsFill, this.mCircleAttribute.mBottomPaint);
    ...
    class CircleAttribute
    {
        ...
        public int mBottomPaintColor= getResources().getColor(R.color.White);
        public int mMainPaintColor=getResources().getColor(R.color.main_color_500);
        ...
        public int   mTextPaintColor=getResources().getColor(R.color.White);
